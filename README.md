...
### My Fork of the coding game known as "Untrusted"
I forked this so I could have a copy just in case more stringent restrictions are placed on the code in the future (because I '''like''' being able to override functions, thank you very much!).  I'm also interested in making a MUMPS version of this game (but it will probably look quite different).
